  ...
  <section class="content"><!-- Default box -->
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title">SISA SAMPLE TCM&nbsp;</h3>
      ...
      <div class="box-body" style="overflow: scroll;">
          ...
          <thead>
            <tr>
              ...
              <td>Tanggal</td>
              <td>Jumlah Modul</td>
              <td>Jml. Sample di Periksa</td>
              <td>Jml. Sample Harus di Periksa</td>
              <td>Jml. Sample di Terima</td>
			  <td>Sisa Sample</td>
            </tr>
          </thead>
			<?php
				include "koneksi.php";
					...
					<tr>
						...
						<td><?php echo $data['jumlah_modul'] ?></td>
               			<td><?php echo $data['sample_periksa'] ?></td>
                		<td><?php echo $data['harus_periksa'] ?></td>
                		<td><?php echo $data['sample_terima'] ?></td>
						<td><?php echo $data['sisa_sample'] ?></td>
					</tr>
				<?php	} ?>
          <tbody>
                  </tbody>
