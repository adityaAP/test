...
<section class="content-header">
  ...
  <section class="content"><!-- Default box -->
    <div class="box">
      ...
      <form class="form-horizontal" id="formPasien" method="post" action="input-aksi.php">
        <div class="box-body">

          <div class="form-group">
            <label class="col-md-2">Tanggal Kegiatan</label>
            <div class="col-md-6">
              <input type="text" name="tanggal" class="datemask form-control" value="" >
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-2">Jumlah Modul</label>
            <div class="col-md-6">
              <input type="text" name="jumlah_modul" class="form-control" value="" placeholder="Jumlah Modul">
            </div>
          </div>
                  <div class="form-group">
            <label class="col-md-2">Jml. Sample di Periksa</label>
            <div class="col-md-6">
              <input type="text" name="sample_periksa" class="form-control" value="" placeholder="Jml. Sample di Periksa">
            </div>
          </div>
                  <div class="form-group">
            <label class="col-md-2">Jml. Sample Harus di Periksa</label>
            <div class="col-md-6">
              <input type="text" name="harus_periksa" class="form-control" value="" placeholder="Jml. Sample Harus di Periksa">
            </div>
          </div>
          <div class="form-group">
            <label class="col-md-2">Jml. Sample di Terima</label>
            <div class="col-md-6">
              <input type="text" name="sample_terima" class="form-control" value="" placeholder="Jml. Sample di Terima">
            </div>
          </div>
			<div class="form-group">
            <label class="col-md-2">Sisa Saldo</label>
            <div class="col-md-6">
              <input type="text" name="sisa_saldo" class="form-control" value="" placeholder="Sisa Saldo">
            </div>
          </div>
...
<sricpt type="text/javascript" src="input.php"></sricpt>
